...
directory = f'/home/shcao/stFormer/dataset/STcorpus/{dataset}/{slide}'


### Preprocess the single-cell reference data
print("Preprocess the single-cell reference data")

if os.path.exists(f'/home/shcao/stFormer/dataset/STcorpus/{dataset}/sc.h5ad'):
    sc_file = f'/home/shcao/stFormer/dataset/STcorpus/{dataset}/sc.h5ad'
# elif os.path.exists(f'{directory}/sc_{slide}.h5ad'):
#     sc_file = f'{directory}/sc_{slide}.h5ad'
else:
